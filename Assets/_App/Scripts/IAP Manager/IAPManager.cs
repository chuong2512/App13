...
public class Key
{
    public const string PACK1 = "app13_pack1";
    public const string PACK2 = "app13_pack2";
    public const string PACK3 = "app13_pack3";
    public const string PACK4 = "app13_pack4";


    public const string PACK1_REGISTER = "register_app13_pack1";
    public const string PACK2_REGISTER = "register_app13_pack2";
    public const string PACK3_REGISTER = "register_app13_pack3";
    public const string PACK4_REGISTER = "register_app13_pack4";
    public const string PACK5_REGISTER = "register_app13_pack5";
}
/// <summary>
/// ////
/// </summary>
